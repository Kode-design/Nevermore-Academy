export default class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        // Puzzle Assets
        this.load.svg('gate', 'assets/gate.svg', { width: 32, height: 200 });
        this.load.svg('switch_off', 'assets/switch_off.svg', { width: 32, height: 32 });
        this.load.svg('switch_on', 'assets/switch_on.svg', { width: 32, height: 32 });
        this.load.svg('rat_hole', 'assets/rat_hole.svg', { width: 32, height: 32 });
    }
